<template>
  <div>
    ...
    <el-form :inline="true">
      ...
      <el-form-item>
        <el-button type="primary" @click="dialogVisible = true"v-if="hasAuth('village:myvillage:save')">新增</el-button>
      </el-form-item>
      <el-form-item>
        <el-popconfirm title="确定批量删除吗？" @confirm="delHandle(null)">
          <el-button type="danger" slot="reference" :disabled="delBtlStatu"v-if="hasAuth('village:myvillage:delete')">批量删除</el-button>
        </el-popconfirm>
      </el-form-item>
    </el-form>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" @click="editHandle(scope.row.id)"v-if="hasAuth('village:myvillage:updata')">编辑</el-button>

<!--          <el-divider direction="vertical"></el-divider>-->

          <template>
            <el-popconfirm title="确定删除吗？" @confirm="delHandle(scope.row.id)">
              <el-button type="text" slot="reference"v-if="hasAuth('village:myvillage:delete')">删除</el-button>
            </el-popconfirm>
          </template>
...
export default {
  ...
  methods:{
    //更新以及查询
    getVillageList() {
      this.$axios.get("/vilman/myvillage/list", {
        params: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$axios.post('/vilman/myvillage/' + (this.editForm.id?'update' : 'save'), this.editForm)
              .then(res => {
    ...
    editHandle(id) {
      this.$axios.get('/vilman/myvillage/info/' + id).then(res => {
    ...
    delHandle(id) {
      ...
      this.$axios.post("/vilman/myvillage/delete", ids).then(res => {
        this.$message({
          showClose: true,
          message: '删除成功！',
          type: 'success',
